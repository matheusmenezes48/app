...
const routes: Routes = [
  ...
  { path: 'novatarefamodal', loadChildren: './novatarefamodal/novatarefamodal.module#NovatarefamodalPageModule' },
  { path: 'novacompramodal', loadChildren: './novacompramodal/novacompramodal.module#NovacompramodalPageModule' },
];
